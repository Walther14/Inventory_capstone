        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="Account_Number" class="form-label">Item Account Number</label>
                            <input type="text" class="form-control" id="Account_Number" name="Account_Number" placeholder="account Number" value="<?= isset($_SESSION['entered_values']['Account_Number']) ? htmlspecialchars($_SESSION['entered_values']['Account_Number']) : '' ?>" required>
                        </div>
