  ...
  <nav class="sidebar offcanvas-start offcanvas-md" tabindex="-1" id="sidebar-example" style="background-color: rgb(255, 255, 255); box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 0 1px 0 rgba(0, 0, 0, 0.19); border-right: none  ;">
    ...
    <div class="" style="background-color:bisque">
      ...
      <div class="d-flex">
        ...
        <div class="col-6" <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/inventory_index.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/User_Management.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/index.php' ? 'style="margin-top: 10rem;"' : 'style="margin-top: 10rem; display: none;"'; ?> id="sidenav1">
          <style>
            .sidebar-nav .nav-item.active a {
              ...
              color: maroon;
              /* Change this to the desired text color for the active link */
              padding: 10px;
              /* Adjust the padding as needed */
              width: 200px;
              border-radius: 8px;
              /* Set a fixed width for the background color */
        ...
        <div class="col-6" <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/totalinven.php'||$_SERVER['REQUEST_URI'] == '/inventory_capstone/receipt.php'||$_SERVER['REQUEST_URI'] == '/inventory_capstone/inspection.php'|| $_SERVER['REQUEST_URI'] == '/inventory_capstone/unProperty.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/inspection_report.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/waste_report.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/physicalcount_inventoriesReport.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/components/inspectionAndAcceptanceReport.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/formsContainer.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/physicalcount_property.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/PreAndPost_report.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/physicalcount_semiReport.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/waste.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/reportsemiIssued.php' || $_SERVER['REQUEST_URI'] == '/inventory_capstone/unSemi.php' ? 'style="margin-top: 10rem;"' : 'style="margin-top: 10rem;  display: none;"'; ?> id="sidenav3">
          <style>
            ...
            <li>
              <ul class="sidebar-nav sidenav3-nav">
                <details>
                  ...
                  <ul class="sidebar-nav sidenav3-nav" style="max-height:10rem; overflow:auto;">
                    <li style="font-size: 15px;" class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/inspection.php' ? 'active' : ''; ?>">
                      <a class="nav-link" href="./inspection.php" aria-current="page">Inspection and Acceptance Report</a>
                    </li>
                    <li>
                      <hr class="sidebar-divider">
                    </li>
                    <li style="font-size: 15px;" class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/waste.php' ? 'active' : ''; ?>">
                      <a class="nav-link" href="./waste.php" aria-current="page">Waste Report</a>
                    </li>
                    <li>
                      <hr class="sidebar-divider">
                    </li>
                    <li style="font-size: 15px;" class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/receipt.php' ? 'active' : ''; ?>">
                      <a class="nav-link" href="./receipt.php" aria-current="page">Receipt of Returned Semi-Expendable Property </a>
                    </li>
                    
                    <li>
                      <hr class="sidebar-divider">
                    </li>
                    <li style="font-size: 15px;" class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/reportsemiIssued.php' ? 'active' : ''; ?>">
                      <a class="nav-link" href="./reportsemiIssued.php" aria-current="page">Report of Semi-Expendable Property Issued</a>
                    </li>
                    <li>
                      <hr class="sidebar-divider">
                    </li>
                    <li style="font-size: 15px;" class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/unSemi.php' ? 'active' : ''; ?>">
                      <a class="nav-link" href="./unSemi.php" aria-current="page">Report of Unserviceable Semi_Expendable Property</a>
                    </li>
                    <li>
                      <hr class="sidebar-divider">
                    </li>
                    <li style="font-size: 15px;" class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/inventory_capstone/unProperty.php' ? 'active' : ''; ?>">
                      <a class="nav-link" href="./unProperty.php" aria-current="page">Report of Unserviceable Property</a>
                    </li>
