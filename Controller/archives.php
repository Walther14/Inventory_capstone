...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $inventory_query = "SELECT * FROM inventory_db WHERE id = '$id'";
    $result = mysqli_query($data, $inventory_query);
