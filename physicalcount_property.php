                            ...
                            <div style="margin: 0.5rem;">
                                <div class="row g-3">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <input type="text" class="form-control" name="aqui[]" placeholder="Date of Acqui" required>
                                    </div>
                                    <div class="col-sm-4">
                                        <label for="description" class="form-label">Description</label>
                                        <input type="text" class="form-control mx-auto" name="description[]" placeholder="Enter or select description" style="width: 100%">
                ...
                <script>
                    document.getElementById('addRowButtonWasteReport').addEventListener('click', function() {
                        ...
                        if (!(tableBody.childElementCount >= 5)) {
                            ...
                            newRow.querySelectorAll('input[name^="Current_Property_Number"]').forEach(function(input) {
                                input.addEventListener('change', function() {
                                    ...
                                    fetch('getUnit.php?Current_Property_Number=' + encodeURIComponent(Current_Property_Number))
                                        ...
                                        .then(data => {
                                            ...
                                            row.querySelector('input[name^="description"]').value = data.property_description;
                                        })
