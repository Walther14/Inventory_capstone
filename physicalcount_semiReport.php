                            ...
                            <div style="margin: 0.5rem;">
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" name="description[]" placeholder="Enter or select description" style="width: 100%">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="number" class="form-control" name="onhand[]" placeholder="Shortage/Overage" required>
                                    </div>
                                    <div class="col-sm-1">
