                        ...
                        <div style="margin: 0.5rem;">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control mx-auto" name="description[]" placeholder="Enter or select description" style="width: 100%" required>
        ...
        <div class="d-flex justify-content-end mb-3 fixed-bottom fixed-right" style="margin-bottom: 10px; margin-right: 10px;">
            ...
            <script>
                function createRow() {
                    ...
                    if (!(tableBodyWasteReport.childElementCount >= 10)) {
