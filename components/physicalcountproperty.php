...
<div class="p-5 d-flex justify-content-center align-items-center remove-print-padding">
    ...
    <td colspan="12">
    <label style="text-align:center;">REPORT ON THE PHYSICAL COUNT OF PROPERTY, PLANT AND EQUIPMENT
...
<tr style="text-align: left;">
    ...
    <td colspan="1"></td>
        ...
        <td colspan="6" for="inspected_by" style="text-align: left;">Prepared by:</td>    
...
<td style="padding: 0px;">
    ...
    <td colspan="6" style="margin-bottom: 10;">
